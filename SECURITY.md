...
Replace this section with the supported versions for `logtriage`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `logtriage` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in logtriage.
